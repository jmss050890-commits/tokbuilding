        ...
        <div className="w-full max-w-md">
          <div className="bg-slate-800/60 backdrop-blur border border-amber-800/30 rounded-lg p-8 shadow-2xl">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-amber-100 mb-2">Welcome Back</h2>
              <p className="text-amber-200/70">Access your Legacy Vault</p>
            </div>
            ...
            <div className="mt-6 p-4 bg-amber-900/20 border border-amber-700/30 rounded text-amber-100 text-xs leading-relaxed">
              ...
              <p>Your Legacy Vault is protected by encrypted authentication. Only you and your authorized family members can access your memorials.</p>
            </div>
          </div>
        </div>
      </div>
