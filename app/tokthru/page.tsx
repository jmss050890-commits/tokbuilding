...
export default function TokThru() {
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {/* Hatata AI Agent */}
              <button
                onClick={() => setCurrentView('hatata')}
                className="p-6 rounded-lg border-2 border-purple-500 bg-purple-500/20 hover:bg-purple-600/30 text-white text-left transition transform hover:scale-105"
              >
                <div className="text-4xl mb-2">✨</div>
                <h3 className="font-bold text-lg">HATATA AI</h3>
                <p className="text-xs text-purple-200">Intelligent emergency guidance and support</p>
              </button>
            </div>
          </div>
  ...
  // ===== HATATA AI COACH VIEW =====
  if (currentView === 'hatata') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="p-8 rounded-lg bg-slate-800 border border-purple-700">
            <h1 className="text-4xl font-bold mb-2 text-white flex items-center gap-3">
              ✨ HATÄTA - Emergency Guidance AI
            </h1>
            <p className="text-slate-400 mb-6">Intelligent crisis support in your moment of need</p>
            
            <div className="bg-purple-900 bg-opacity-30 border border-purple-700 rounded-lg p-6 mb-6 text-center">
              <p className="text-purple-200 text-lg font-semibold">
                Ready to talk to HATÄTA? Click below for intelligent emergency guidance and support.
              </p>
            </div>

            <Link 
              href="/agent/hatata"
              className="w-full block px-6 py-4 rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-bold text-center transition text-lg"
            >
              💬 Open HATÄTA Chat
            </Link>
          </div>
