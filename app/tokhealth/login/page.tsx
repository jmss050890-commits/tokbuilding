...
export default function TokHealthLoginPage() {
        ...
        <div className="w-full max-w-md">
          <div className="bg-slate-800/60 backdrop-blur border border-green-800/30 rounded-lg p-8 shadow-2xl">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-green-100 mb-2">Welcome to TokHealth</h2>
              <p className="text-green-200/70">Sign in to your health profile</p>
            </div>
