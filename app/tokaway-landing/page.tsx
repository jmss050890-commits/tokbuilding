...
export default function TokAwayLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 text-white">
      ...
      {/* Footer Navigation */}
      <footer className="bg-slate-950 border-t border-blue-700/20 py-8 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <nav className="space-y-2">
                <Link href="/tokaway-landing" className="text-slate-400 hover:text-blue-400 transition">
                  TokAway
                </Link>
                <br />
                <Link href="/toksmart" className="text-slate-400 hover:text-blue-400 transition">
                  TokSmart
                </Link>
                <br />
                <Link href="/tokhealth" className="text-slate-400 hover:text-blue-400 transition">
                  TokHealth
                </Link>
              </nav>
            </div>
