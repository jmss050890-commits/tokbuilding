...
${SVL_SHARED_OPERATING_CONTEXT}`),
  ...
  hatata: {
    ...
    commandFrameworkCopy:
      "HATATA is now tuned to answer like a command agent: not just what changed, but what it unlocks, where the pressure points are, and what should happen next.",
